...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<QTIPARRAYAmountField*>("payAmount")->setValue(amount);
...
void TestGUI()
{
    ...
    // Amount input
    QTIPARRAYAmountField* amountInput = receiveCoinsDialog.findChild<QTIPARRAYAmountField*>("reqAmount");
