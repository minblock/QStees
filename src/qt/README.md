...
Used to process BIP21 and BIP70 (see https://github.com/sin/sin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a sin:... link from a browser).
...
* `sinunits.(h/cpp)`: QTIPARRAY / mQTIPARRAY / etc handling
* `callback.h`
